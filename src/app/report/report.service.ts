...
const reportsList: Report[] = [
    ...
    new Report("ISV Co-Sell Dashboard", "1d9ee913-1bc1-4936-83b2-ccfb81e169eb", "be4af5f0-770e-4e90-b7f0-9e04c864d7a8", new AccountFilterConfig("Account", "TP Account Name", "Partner Sales Connect Deals", "TPID", true), 'http://aka.ms/ocpinsights', rpt => {
      rpt.getPages().then(pages => {
        pages.forEach(p => {
          if (p.displayName == "Deal Reg Details")
            rpt.setPage(p.name);
        });
      });
    })
